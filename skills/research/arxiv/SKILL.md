...
# Full paper (PDF → markdown via web_fetch)
...
> Note: the helper script lives in the Hermes skills repo (`scripts/search_arxiv.py`).
> If absent locally, use the inline python3 parsing snippets above instead.
