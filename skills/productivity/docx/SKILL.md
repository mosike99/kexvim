...
ls page-*.jpg   # then inspect each with vision
```
...
2. Render to PDF → images (see "Verify the output") and inspect each page with `vision` — look for broken tables, missing images, spacing artifacts, leftover placeholder text.
